...
### Core Coursework
*(take these in order)*
#### [1. Complete Intro to Web Development](./01-complete-intro-to-web-development.md)
...
#### [2. Getting Started with CSS](./02-getting-started-with-css.md)
...
#### [3. Getting Started with JavaScript](./03-getting-started-with-javascript.md)
...
#### [4. JavaScript: From Fundamentals to Functional JS](./04-javascript-from-fundamentals-to-functional.md)
